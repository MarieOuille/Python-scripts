...
# parameters to tweak
lambd = 793 # laser central wavelength in nanometer
hbar = 1.0545718e-34  #Planck constant 
c = 299792458  # speed of light
e = 1.6021766208e-19  #J = 1eV
deltaE = hbar *2*np.pi*c /(lambd*1e-9) /e  # photon energy spacing, if odd *and even* harmonics present
smoothwidth = 1 # over how many pixels to make a running-average-smoothing of the spectra.
                  # this makes peak-finding easier in noisy data.
peaksearch_contrast = 1 #how many counts difference you require between a 'minimum' and a 'maximum' in the peak search
pxwidth = 5 #number of pixels left and right of the found maxima to include in the center-of-weight search
gratinglines=600e3 #600 lines per mm
cam_dist = l = 469e-3 #m
inc_angle=85.3 # degres
pxsize = 1.65e-4
const1 = hbar/e *2*np.pi*c *gratinglines  
...
print('\n','the lowest multiple of that spacing" = ',str(C),',')
