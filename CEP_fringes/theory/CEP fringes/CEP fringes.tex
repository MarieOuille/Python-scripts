...
We use a BBO crystal to frequency double the red components.\\

Let's assume the SHG field is a gaussian centered around $\omega_{0, blue}$, corresponding to 480nm : \\


$E_{SHG}(\omega) = \sqrt{att}  \ e^ {- \frac{a_{blue}^2}{2}(\omega - \omega_{0, blue})^2}  e^{ -i2\Phi(\omega) }$ \\
