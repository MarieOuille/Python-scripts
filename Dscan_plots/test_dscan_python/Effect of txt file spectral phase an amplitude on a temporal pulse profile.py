...
####### interpolation de l'amplitude et la phase spectrale
end= np.size(nu)-1
spectrum_I_nu=[]
...
########## ajout d'une phase spectrale polynomiale
lambdac = 780. #nm
nuc = c0/lambdac  # fs-1
GD= 0.
GDD= 0.
...
s.set_ylim([0,1])
# phase spectrale du dscan et corrigée :
ph=s.twinx()
